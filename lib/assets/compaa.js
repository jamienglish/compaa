var Compaa = (function() {
  ...
  Compaa.prototype = {
    ...
    drawDifferenceCanvas: function() {
      var self, newImg, oldImg, over, under;
      self = this;
      ...
      oldImg.load(function() {
        $('#difference').width(this.width).height(this.height);

        newImg.load(function() {
          $('#offScreenCanvas').width(this.width).height(this.height);

          over.drawImage(oldImg[0], 0, 0);
          under.drawImage(newImg[0], 0, 0);
