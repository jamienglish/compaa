var Compaa = {
  ...
  attachButtonClickHandlers: function() {
    this.imageTypes.forEach(function(element) {
      $(document.getElementById(element + 'Button')).click(function(evt) {
        evt.preventDefault();
        this.show(element);
      }.bind(this));
    }, this);
  ...
  attachAcceptClickHandler: function() {
    $(document.getElementById('accept')).click(function(e) {
      e.preventDefault();
      this.acceptImage();
    }.bind(this));
  },
  ...
  attachRejectClickHandler: function() {
    $(document.getElementById('reject')).click(function(e) {
      e.preventDefault();
      this.rejectImage();
    }.bind(this));
  },
